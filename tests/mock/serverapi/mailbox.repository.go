...
func (m *MockMailRepository) DeleteFolder(login, foldername string) error {
	m.ctrl.T.Helper()
...
func (mr *MockMailRepositoryMockRecorder) DeleteFolder(login, foldername interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteFolder", reflect.TypeOf((*MockMailRepository)(nil).DeleteFolder), login, foldername)
}
...
func (m *MockMailRepository) FindMessages(login, request string) ([]int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMailRepositoryMockRecorder) FindMessages(login, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindMessages", reflect.TypeOf((*MockMailRepository)(nil).FindMessages), login, request)
}
